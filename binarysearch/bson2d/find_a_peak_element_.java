...
public class find_a_peak_element_ {
    public static int maxElement(int mat[][], int row, int n, int m) {
        int maxi = 0, idx = -1;
    ...
    public static void main(String[] args) {
        System.out.println(maxElement(new int[][] {{1,2,3},{4,5,6},{7,8,9}} , 3, 6, 3));
    }
}
